...
const HowItWorks = ({ isVisible  }) => {
  return (
    <section id="how-it-works" className={`py-5 ${isVisible ? 'anim-active' : ''}`}>
      <div className="container">
        <div className="block-header text-center">
          <h2>How It Works</h2>
        </div>
        <div className="text-wrap text-center mb-5 w-50 mx-auto">
          <p>Before booking for any of our services, you have the right to know our work process from beginning to completion. We will arrive on your property and give a clear estimate, so you understand precisely what you’ll be paying for.</p>
        </div>
